...
import main.java.cz.jirutka.rsql.parser.ast.*;
  ...
  final public Node Or() throws ParseException {
    ...
    while (true) {
      ...
      node = And();
        ...
        {if (true) return nodes.size() != 1 ? factory.createLogicalNode(LogicalOperator.OR, nodes) : nodes.get(0);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public Node And() throws ParseException {
    ...
    while (true) {
      ...
      node = Constraint();
        ...
        {if (true) return nodes.size() != 1 ? factory.createLogicalNode(LogicalOperator.AND, nodes) : nodes.get(0);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public String Argument() throws ParseException {
    ...
    case DOUBLE_QUOTED_STR:
      ...
      default:
        ...
        {if (true) return unescape(token.image.substring(1, token.image.length() -1));}
      break;
    default:
      jj_la1[7] = jj_gen;
      jj_consume_token(-1);
